...
var PartnerSpecificValidator = require('adomik-nob-validator.js');
...
function AdomikNob(configs) {
    ...
    (function __constructor() {
        ...
        __profile = {
            partnerId: 'AdomikNob', // PartnerName
            namespace: 'AdomikNob', // Should be same as partnerName
            statsId: 'AMIK', // Three character unique partner identifier
            version: '2.0.0',
            targetingType: 'slot',
            enabledAnalytics: {
                requestTime: true
